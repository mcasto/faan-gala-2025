        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        <h2 class="text-2xl font-semibold">Edit Auction Item</h2>
                    </div>

                    <form action="{{ route('admin.auction-items.update', $item) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="donor_name" id="donor_name"
                                        ...
                                        value="{{ old('donor_name', $item->donor_name) }}" required>
                                    @error('donor_name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="individual_name" id="individual_name"
                                        ...
                                        value="{{ old('individual_name', $item->individual_name) }}" required>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="address_2" id="address_2"
                                        ...
                                        value="{{ old('address_2', $item->address_2) }}">
                                    @error('address_2')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="description" id="description" rows="4"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('description') border-red-500 @enderror">{{ old('description', $item->description) }}</textarea>
                                    @error('description')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="terms_and_conditions" id="terms_and_conditions" rows="4"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('terms_and_conditions') border-red-500 @enderror">{{ old('terms_and_conditions', $item->terms_and_conditions) }}</textarea>
                                    ...
                                    @if ($item->item_image_path)
                                        <div class="mb-2">
                                            <img src="{{ Storage::url($item->item_image_path) }}"
                                                alt="Current item image" class="max-w-xs">
                                        </div>
                                    @endif
                                ...
                                <div>
                                    ...
                                    <input type="date" name="item_received_date" id="item_received_date"
                                        ...
                                        value="{{ old('item_received_date', $item->item_received_timestamp ? date('Y-m-d', strtotime($item->item_received_timestamp)) : '') }}">
                                ...
                                <div>
                                    ...
                                    <input type="time" name="item_received_time" id="item_received_time"
                                        ...
                                        value="{{ old('item_received_time', $item->item_received_timestamp ? date('H:i', strtotime($item->item_received_timestamp)) : '') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="faan_volunteer" id="faan_volunteer"
                                        ...
                                        value="{{ old('faan_volunteer', $item->faan_volunteer) }}">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="volunteer_email" id="volunteer_email"
                                        ...
                                        value="{{ old('volunteer_email', $item->volunteer_email) }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="admin_notes" id="admin_notes" rows="4"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('admin_notes') border-red-500 @enderror">{{ old('admin_notes', $item->admin_notes) }}</textarea>
                                    @error('admin_notes')
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
